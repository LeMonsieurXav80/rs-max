        ...
        <div class="min-h-screen flex">
            ...
            >
                ...
                <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                    ...
                    <div x-data="{ publierOpen: {{ str_starts_with($currentRoute, 'posts/create') || str_starts_with($currentRoute, 'posts/bulk') || str_starts_with($currentRoute, 'threads/create') ? 'true' : 'false' }} }" class="mb-3">
                        ...
                        <div x-show="publierOpen" x-collapse class="ml-5 mt-1 space-y-0.5 border-l border-indigo-200 pl-3">
                            ...
                            <a href="{{ route('posts.bulk.create') }}"
                               class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors {{ str_starts_with($currentRoute, 'posts/bulk') ? 'bg-indigo-50 text-indigo-600 font-medium' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                    ...
                    {{-- Edition en masse (sous-page de Medias) --}}
                    <a href="{{ route('media.manage') }}"
                       class="flex items-center gap-3 px-3 py-2 pl-11 rounded-xl text-sm transition-colors {{ $currentRoute === 'media/manage' ? 'bg-indigo-50 text-indigo-600 font-medium' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
