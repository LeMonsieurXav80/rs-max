...
@section('content')
    ...
    <form method="POST" action="{{ route('rss-feeds.store') }}" class="max-w-3xl"
          x-data="{
              selectedAccounts: [],
              toggleAccount(id) {
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="category" id="category" value="{{ old('category') }}"
                               class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm"
                               placeholder="Ex: Tech, Actualités, Sport">
                ...
                <div class="mt-4">
                    ...
                    <input type="url" name="url" id="url" value="{{ old('url') }}" required
                           class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm"
                           placeholder="Ex: https://example.com/feed.xml ou https://www.youtube.com/feeds/videos.xml?channel_id=...">
                ...
                <div class="mt-4 flex items-center gap-3">
                    ...
                    <input type="checkbox" name="is_multi_part_sitemap" id="is_multi_part_sitemap" value="1"
                           {{ old('is_multi_part_sitemap') ? 'checked' : '' }}
