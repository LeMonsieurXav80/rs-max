    ...
    <form method="POST" action="{{ route('personas.update', $persona) }}" class="max-w-3xl">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-6">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 mb-3">Règles de formatage pour le contenu généré.</p>
                <textarea name="output_instructions" id="output_instructions" rows="4"
                          class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm font-mono">{{ old('output_instructions', $persona->output_instructions) }}</textarea>
