...
@section('title', 'Nouveau site WordPress')
...
@section('content')
    ...
    <form method="POST" action="{{ route('wordpress-sites.store') }}" class="max-w-3xl"
          x-data="{
              testing: false,
              testResult: null,
              testError: null,
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-6">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" required
                               ...
                               placeholder="Ex: Mon Blog WordPress">
                ...
                <div class="mt-4 p-4 bg-gray-50 rounded-xl">
                    <p class="text-xs font-medium text-gray-600 mb-3">Authentification (optionnel, pour les sites protégés)</p>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label for="auth_username" class="block text-xs font-medium text-gray-500 mb-1">Identifiant</label>
                            <input type="text" name="auth_username" id="auth_username" value="{{ old('auth_username') }}"
                                   class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm"
                                   placeholder="Nom d'utilisateur WP">
                        </div>
                        <div>
                            ...
                            <input type="password" name="auth_password" id="auth_password"
                                   class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm"
                                   placeholder="Application Password WP">
                        </div>
                    </div>
                    <p class="text-xs text-gray-400 mt-2">Utilisez un mot de passe d'application WordPress (Utilisateurs > Profil > Mots de passe d'application).</p>
                </div>
            ...
            {{-- Types de contenu (dynamiques) --}}
            <template x-if="availableTypes.length > 0">
                <div>
                    ...
                    <p class="text-xs text-gray-500 mb-4">Cochez les types de contenu que vous souhaitez importer depuis ce site.</p>
