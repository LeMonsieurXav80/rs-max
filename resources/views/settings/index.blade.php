                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                    ...
                    <div class="max-w-md">
                        ...
                        <select id="{{ \App\Services\Carousel\StudioDefaults::FOLDER_KEY }}"
                                ...
                                class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                            {{-- Bloc complet, jamais la forme courte à parenthèses : les
                                 parenthèses imbriquées de old(...) trompent son parseur, qui
                                 avale silencieusement la fin du fichier (page en 500). --}}
                            @php
                                $folderKey = \App\Services\Carousel\StudioDefaults::FOLDER_KEY;
                                $currentFolder = old($folderKey, $settings[$folderKey]);
                            @endphp
