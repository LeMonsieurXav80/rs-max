...
return new class extends Migration
{
    ...
    {
        Schema::create('yt_source_social_account', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['yt_source_id', 'social_account_id']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('yt_source_social_account');
    }
};
