...
@section('title', 'Modifier flux RSS/XML')
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        ...
                        <select name="schedule_frequency" id="schedule_frequency"
                                class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                            <option value="daily" {{ old('schedule_frequency', $rssFeed->schedule_frequency) === 'daily' ? 'selected' : '' }}>Quotidien</option>
                            <option value="twice_weekly" {{ old('schedule_frequency', $rssFeed->schedule_frequency) === 'twice_weekly' ? 'selected' : '' }}>2x par semaine</option>
                            <option value="weekly" {{ old('schedule_frequency', $rssFeed->schedule_frequency) === 'weekly' ? 'selected' : '' }}>Hebdomadaire</option>
                            <option value="biweekly" {{ old('schedule_frequency', $rssFeed->schedule_frequency) === 'biweekly' ? 'selected' : '' }}>Tous les 15 jours</option>
                            <option value="monthly" {{ old('schedule_frequency', $rssFeed->schedule_frequency) === 'monthly' ? 'selected' : '' }}>Mensuel</option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="time" name="schedule_time" id="schedule_time" value="{{ old('schedule_time', $rssFeed->schedule_time ?? '10:00') }}"
                               class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
