...
@section('title', 'Modifier persona')
...
@section('content')
    ...
    <form method="POST" action="{{ route('personas.update', $persona) }}" class="max-w-3xl">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-6">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="tone" id="tone" value="{{ old('tone', $persona->tone) }}"
                               class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                ...
                <div class="mt-4">
                    ...
                    <input type="text" name="description" id="description" value="{{ old('description', $persona->description) }}"
                           class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 mb-3">Définissez le rôle et la personnalité de l'IA.</p>
                <textarea name="system_prompt" id="system_prompt" rows="6" required
                          class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm font-mono">{{ old('system_prompt', $persona->system_prompt) }}</textarea>
            ...
            <div class="flex items-center gap-3">
                ...
                <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $persona->is_active) ? 'checked' : '' }}
                ...
                <div class="mt-4 space-y-4">
                    <div>
                        ...
                        <input type="number" name="bot_comment_max_length" id="bot_comment_max_length"
                               value="{{ old('bot_comment_max_length', $persona->bot_comment_max_length ?? 280) }}"
                               min="50" max="1000"
                    ...
                    <div>
                        ...
                        <textarea name="bot_comment_context_text" id="bot_comment_context_text" rows="3"
                                  ...
                                  class="w-full rounded-xl border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm">{{ old('bot_comment_context_text', $persona->bot_comment_context_text) }}</textarea>
                        @error('bot_comment_context_text') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="bot_comment_context_article" id="bot_comment_context_article" rows="3"
                                  ...
                                  class="w-full rounded-xl border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm">{{ old('bot_comment_context_article', $persona->bot_comment_context_article) }}</textarea>
                        @error('bot_comment_context_article') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="bot_comment_context_image" id="bot_comment_context_image" rows="3"
                                  ...
                                  class="w-full rounded-xl border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm">{{ old('bot_comment_context_image', $persona->bot_comment_context_image) }}</textarea>
                        @error('bot_comment_context_image') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
